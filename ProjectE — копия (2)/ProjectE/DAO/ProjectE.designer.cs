...
namespace ProjectE.DAO
{
    ...
    partial void InsertTypeOperation(TypeOperation instance);
    partial void UpdateTypeOperation(TypeOperation instance);
    partial void DeleteTypeOperation(TypeOperation instance);
    ...
    partial void DeleteObjects(Objects instance);
		...
		public System.Data.Linq.Table<TypeOperation> TypeOperation
		{
			get
			{
				return this.GetTable<TypeOperation>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.TypeOperation")]
	public partial class TypeOperation : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnNameChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TypeOperation_Objects", Storage="_Objects", ThisKey="Id", OtherKey="OperationID")]
		public EntitySet<Objects> Objects
		{
			get
			{
		...
		{
			this.SendPropertyChanging();
			entity.TypeOperation = this;
		}
		
		private void detach_Objects(Objects entity)
		{
			this.SendPropertyChanging();
			entity.TypeOperation = null;
		}
	}
	...
	public partial class Objects : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<TypeOperation> _TypeOperation;
    ...
    partial void OnOperationIDChanged();
		...
		public Objects()
		{
			...
			this._User = default(EntityRef<User>);
			this._TypeOperation = default(EntityRef<TypeOperation>);
			OnCreated();
		}
		...
		public System.Nullable<int> OperationID
		{
			...
			set
			{
				...
				{
					if (this._TypeOperation.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TypeOperation_Objects", Storage="_TypeOperation", ThisKey="OperationID", OtherKey="Id", IsForeignKey=true)]
		public TypeOperation TypeOperation
		{
			get
			{
				return this._TypeOperation.Entity;
			}
			set
			{
				TypeOperation previousValue = this._TypeOperation.Entity;
				if (((previousValue != value) 
							|| (this._TypeOperation.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._TypeOperation.Entity = null;
						previousValue.Objects.Remove(this);
					}
					this._TypeOperation.Entity = value;
					if ((value != null))
					{
						value.Objects.Add(this);
